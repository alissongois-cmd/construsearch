...
type SearchResult = { valor: number | string; data_atualizacao: string; materiais: { nome: string } | null; lojas: { nome: string; cidade: string } | null };
